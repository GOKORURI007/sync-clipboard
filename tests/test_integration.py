...
class TestServerClientIntegration:
    ...
    def mock_clipboard_backend(self):
        ...
        with (
            patch('pyperclip.paste', side_effect=mock_clipboard.paste),
    ...
    def test_server_client_basic_communication(self, mock_clipboard_backend, event_loop):
        ...
        async def _test():
            ...
            client_message = Message(
                type='clipboard_update', sender_id=client_hostname, content=test_content
            )
            ...
            server_message = Message(
                type='clipboard_update', sender_id=server_hostname, content=test_content
            )
            ...
            assert mock_clipboard_backend.content == '', 'Client should ignore messages from itself'
    ...
    def test_multi_client_scenario(self, mock_clipboard_backend, event_loop):
        ...
        async def _test():
            ...
            assert len(sender_ws.sent_messages) == 0, 'Sender should not receive its own message'
            ...
            for hostname in client_hostnames[1:]:
                ...
                assert message.sender_id == sender_hostname, (
                    'Message should identify correct sender'
                )
            ...
            for hostname in client_hostnames:
                ...
                assert message.sender_id == server_hostname, (
                    'Message should identify server as sender'
                )
    ...
    def test_message_protocol_integration(self, mock_clipboard_backend, event_loop):
        ...
        async def _test():
            ...
            # Create message
            message = Message(type='clipboard_update', sender_id=sender_id, content=test_content)
            ...
            hello_message = Message(type='client_hello', sender_id='test_client')
